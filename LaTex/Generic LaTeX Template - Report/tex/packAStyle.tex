...
%\usepackage{subfig}  %Placing figures/tables side-by-side,
...
\usepackage{lmodern} %enhanced versions of the Computer Modern fonts, which is the default
	
\usepackage{amssymb,amsmath} %formelsatz

\usepackage[pdfstartview={FitV},hidelinks]{hyperref} %enables typesetting of followable hyperlinks
